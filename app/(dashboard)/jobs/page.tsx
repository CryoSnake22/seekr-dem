...
import { Target, CheckCircle2, AlertCircle, ArrowLeft } from '@/components/ui/Icon';
...
export default function JobsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold mb-2">Job Match Analyzer</h1>
        <p className="text-neutral-400">
          Analyze job postings to see your match score and identify skill gaps
        </p>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 ml-4">
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-sm text-red-400 hover:bg-red-500/10 border border-transparent hover:border-red-500/20 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                  >
                    Delete
                  </button>
                </div>
