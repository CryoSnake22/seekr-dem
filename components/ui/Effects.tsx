...
export const GlowCard: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = "" }) => {
  return (
    <div
      className={`glass-card relative overflow-hidden rounded-xl p-6 transition-all duration-300 group hover:-translate-y-[5px] hover:shadow-[0_0_20px_rgba(16,185,129,0.1)] ${className}`}
    >
