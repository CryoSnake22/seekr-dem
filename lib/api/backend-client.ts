...
class BackendClient {
   ...
   * GET request
   */
  async get<T>(path: string, token: string, options?: RequestOptions): Promise<BackendResponse<T>> {
   ...
   * DELETE request
   */
  async delete<T>(path: string, token: string, options?: RequestOptions): Promise<BackendResponse<T>> {
